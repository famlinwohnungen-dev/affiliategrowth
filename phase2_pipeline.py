...
def fetch_awin_programmes(session_factory) -> int:
    ...
    programmes = collector.fetch_all_available()
        ...
        for raw_prog in programmes:
            ...
            if existing:
                ...
                prog = AffiliateProgram(
                    ...
                    sector=raw_prog.get("primarySector", ""),
                    website=raw_prog.get("displayUrl", ""),
                    support_url=raw_prog.get("clickThroughUrl", ""),
                    country=(raw_prog.get("primaryRegion") or {}).get("countryCode", "DE"),
                    language=raw_prog.get("language", "de"),
                    is_active=1 if str(raw_prog.get("status", "")).lower() == "active" else 0,
